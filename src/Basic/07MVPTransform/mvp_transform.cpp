...
const char* vertexPath = "src/Basic/07MVPTransform/simple.vs";
const char* fragmentPath = "src/Basic/07MVPTransform/simple.fs";
...
//    glUniformMatrix4fv(transformLoc, 1, GL_FALSE, glm::value_ptr(trans));
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        v_matrix = glm::translate(v_matrix, glm::vec3(0.0f, 0.0f, -5.0f));
        shaderProgram.setMat4(V_Mat4Str, v_matrix);

        glm::mat4 p_matrix = glm::mat4(1.0f);
        p_matrix = glm::perspective(glm::radians(45.0f), (float)WIDTH / (float)HEIGHT, 0.1f, 100.0f);
        ...
        for(unsigned int i = 0; i < 10; i++)
        {
            ...
            m_matrix = glm::rotate(m_matrix, (float)glfwGetTime() * glm::radians(45.0f * (i + 1)), glm::vec3(1.0f, 0.3f, 0.5f));
