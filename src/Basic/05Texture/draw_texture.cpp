...
const char* vertexPath = "C:/CWorkSpace/LearnOpenGL/src/Basic/05Texture/simple.vs";
const char* fragmentPath = "C:/CWorkSpace/LearnOpenGL/src/Basic/05Texture/simple.fs";
